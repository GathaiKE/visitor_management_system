...
@Component({
  selector: 'app-all',
  standalone: true,
  imports: [SpinnerComponent, NgFor, PaginatorComponent, FormComponent, FormsModule, NgClass],
...
export class AllComponent {
  ...
  constructor(private risitorsService:VisitorsService, private router:Router){}
  ...
  fetchData(){
    ...
    this.risitorsService.getVisitors().subscribe(res=>{
      if(res.data){
